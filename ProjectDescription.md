...
敌人血条通过 UMG Widget 实现，并由 Widget Component 挂载到敌人身上。血条 Widget 持有敌人引用，通过调用 `GetHealthPercent()` 获取当前生命百分比，并根据敌人受伤后的血量变化刷新显示。
...
当所有玩家累计成功开火达到 30 次后，服务器判定游戏胜利，并通知所有客户端显示胜利界面。胜利 UI 中间显示“游戏胜利”，下方提供退出按钮。
